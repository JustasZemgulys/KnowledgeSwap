...
class _DiscussionScreenState extends State<DiscussionScreen> {
  ...
  Future<void> _fetchItemDetails() async {
    try {
      final response = await http.get(Uri.parse(
          'https://juszem1-1.stud.if.ktu.lt/get_item_details.php?id=${widget.itemId}&type=${widget.itemType}'));
  ...
  Future<void> _fetchComments() async {
    try {
      final response = await http.get(Uri.parse(
        'https://juszem1-1.stud.if.ktu.lt/get_comments.php?item_id=${widget.itemId}&item_type=${widget.itemType}&user_id=${userInfo.id}'));
  ...
  Future<void> _postComment() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://juszem1-1.stud.if.ktu.lt/post_comment.php'),
        body: body,
      );
  ...
  if (newText != null && newText.trim() != currentText.trim()) {
    ...
    try {
      final response = await http.post(
        Uri.parse('https://juszem1-1.stud.if.ktu.lt/update_comment.php'),
  ...
  Future<void> _deleteComment(int commentId) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('https://juszem1-1.stud.if.ktu.lt/delete_comment.php'),
        body: {
